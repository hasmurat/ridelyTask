...
describe("Adding trainer response to user request without media content", async function () {
    ...
    it("Send Response without media content and verify it", async function () {
